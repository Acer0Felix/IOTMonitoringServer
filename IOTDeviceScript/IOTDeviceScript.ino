...
const char ssid[] = "Familia Acero"; // TODO cambiar por el nombre de la red WiFi
// Contraseña de la red WiFi
const char pass[] = "Sol1DeoGlor1a"; // TODO cambiar por la contraseña de la red WiFi

//Conexión a Mosquitto
#define USER "Superuser" // TODO Reemplace UsuarioMQTT por un usuario (no administrador) que haya creado en la configuración del bróker de MQTT.
const char MQTT_HOST[] = "34.201.28.61"; // TODO Reemplace ip.maquina.mqtt por la IP del bróker MQTT que usted desplegó. Ej: 192.168.0.1
const int MQTT_PORT = 8082;
const char MQTT_USER[] = USER;
//Contraseña de MQTT
const char MQTT_PASS[] = "acerofel"; // TODO Reemplace ContrasenaMQTT por la contraseña correpondiente al usuario especificado.
...
float humi;
// Valor de la medición de la luminocidad
float lumi;
 ...
 */
void sendSensorData(float temperatura, float humedad, float luminocidad) {
  String data = "{";
  data += "\"temperatura\": "+ String(temperatura, 1) +", ";
  data += "\"humedad\": "+ String(humedad, 1) +", ";
  data += "\"luminocidad\": "+ String(luminocidad, 1);
  data += "}";
...
/**
 * Lee la luminocidad del sensor de luminocidad en A0, la imprime en consola y la devuelve.
 */
float readLuminocidad() {
  
  // Se lee la luminocidad 
